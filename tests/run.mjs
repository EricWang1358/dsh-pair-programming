...
const suites = ['protocol.test.mjs', 'state.test.mjs', 'gate.test.mjs', 'story.test.mjs', 'settings.test.mjs', 'client.test.mjs', 'members.test.mjs', 'lifecycle.test.mjs', 'collapse.test.mjs'];
