...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function CardForm(scope, specs) {
      ...
      self.open = { protocol: true, budgets: false, gate: false, model: false, ce: false, diag: false };
    ...
    function Section(p) {
      ...
      return h('div', { style: { margin: '12px 0 0' } },
        h('button', {
          type: 'button', onClick: p.onToggle,
          style: {
            display: 'flex', alignItems: 'center', gap: 6, width: '100%', textAlign: 'left',
            background: 'none', border: 'none', padding: '6px 0', cursor: 'pointer',
            fontSize: 13, fontWeight: 600, borderTop: '1px solid rgba(128,128,128,.2)',
          },
        },
    ...
    function PairCard(props) {
      ...
      function section(key, titleKey, summaryKey, names, children) {
        var g = group(names);
        return h(Section, {
      ...
      var project = function () {
        return {
          ...
          fields: {
            ...
            navigatorModel: form.field('navigatorModel'),
