...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var EN = {
      ...
      defaultMode: 'Default team mode', defaultModeHint: 'light is Driver + Navigator (default); full adds the legacy Challenger seat.',
    ...
    var ZH = {
      ...
      defaultMode: '默认团队模式', defaultModeHint: 'light 为 Driver + Navigator（默认）；full 另加遗留的 Challenger 席位。',
