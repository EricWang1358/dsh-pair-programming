  ...
  factory: function (require) {
    ...
    function PairCard(props) {
      ...
      return h('li', { style: { listStyle: 'none', border: '1px solid rgba(128,128,128,.35)', borderRadius: 12, padding: '4px 16px 12px', margin: '0 0 16px' } },
        ...
        h(CheckRow, Object.assign({ label: t('oracleFirst'), hint: t('oracleFirstHint') }, bind('oracleFirst'))),
        h(InputRow, Object.assign({ label: t('oracleForkBudget'), hint: t('oracleForkBudgetHint'), numeric: true }, bind('oracleForkBudget'), { invalidCopy: t('invalidNumber') })),
        h(SelectRow, Object.assign({ label: t('memberLifetime'), hint: t('memberLifetimeHint'), options: MEMBER_LIFETIMES }, bind('memberLifetime'), { invalidCopy: t('invalidNumber') })),
        ...
        h(InputRow, Object.assign({ label: t('dodCommand'), hint: t('dodCommandHint') }, bind('dodCommand'))),
        h('h4', { style: { margin: '14px 0 0' } }, t('ceSection')),
        h(SelectRow, Object.assign({ label: t('ceLanes'), hint: t('ceLanesHint'), options: CE_LANES }, bind('ceLanes'), { invalidCopy: t('invalidNumber') })),
        h(SelectRow, Object.assign({ label: t('ceSoloLane'), hint: t('ceSoloLaneHint'), options: CE_SOLO_LANES }, bind('ceSoloLane'), { invalidCopy: t('invalidNumber') })),
        h(InputRow, Object.assign({ label: t('cePath'), hint: t('cePathHint') }, bind('cePath'))),
        h(InputRow, Object.assign({ label: t('ceProbeToken'), hint: t('ceProbeTokenHint') }, bind('ceProbeToken'))),
        h(CeStatusBlock, {
      ...
      var store = form.bindStore(function () {
        return {
          ...
          fields: {
            ...
            dod: form.field('dod'),
            dodCommand: form.field('dodCommand'),
            ceLanes: form.field('ceLanes'),
            ceSoloLane: form.field('ceSoloLane'),
            cePath: form.field('cePath'),
            ceProbeToken: form.field('ceProbeToken'),
          },
        };
      });
