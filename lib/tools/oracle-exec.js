 ...
 * repository fallback recursively hashes files; it is not bounded or isolated.
 */
 ...
 */
export async function runOracleCommand(workspace, command, { signal, timeoutMs = ORACLE_TIMEOUT_MS } = {}) {
