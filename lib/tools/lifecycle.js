...
export function registerLifecycleTools(ctx, config, runtime) {
  ...
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      drivers: { type: 'number', description: '1 (default) or 2. Two Drivers require a clean Git repository and use separate worktrees with serialized, tested integration. Omitted uses the Experimental: Isolated dual Drivers setting when it has a dedicated integration command; mode then defaults to light.' },
