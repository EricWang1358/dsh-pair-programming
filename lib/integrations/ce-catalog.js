...
export const CE_SKILLS = Object.freeze([
  ...
  { name: 'ce-code-review', pairSurface: 'model', description: 'Structured code review for bugs, regressions, tests and standards; before a PR or on request.' },
  // MEASURED against the skill's own frontmatter (2026-09-11, ce-proof/SKILL.md:3):
  // "Publish, read, comment on, or edit markdown in Proof. Use for Proof links, sharing
  // specs/plans/drafts, or publish handoffs from planning workflows." The line this row
  // used to carry - 'Check each claim against the evidence that is supposed to support it'
  // - was a capability GUESSED FROM THE NAME, and it pointed evidence review at a document
  // editor. Authoring a description is allowed; inventing one is not: read the body first.
  { name: 'ce-proof', pairSurface: 'model', description: 'Publish, read, comment on or edit markdown in a Proof document (shares specs/plans); not evidence review.' },
  { name: 'ce-doc-review', pairSurface: 'model', description: 'Review requirements, plans or specs with role-specific lenses; improves an existing planning doc.' },
  { name: 'ce-pov', pairSurface: 'model', description: 'Give a decisive, project-grounded point of view: a graded verdict or a position on a document.' },
  { name: 'ce-debug', pairSurface: 'model', description: 'Diagnosis loop for bugs and failing or slow behaviour; localise and eliminate hypotheses.' },
  { name: 'ce-explain', pairSurface: 'model', description: 'Create a durable visual teaching artifact for a topic worth learning; a deep explainer.' },
  { name: 'ce-simplify-code', pairSurface: 'model', description: 'Simplify settled, recently changed code for clarity, reuse and quality while preserving behaviour.' },
