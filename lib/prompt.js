...
5. Arbitrate deadlocks (2-round Driver/Navigator disagreement, or 3 consecutive gate failures) on repository evidence, logging the decision with pair_arbitrate.
...
Tools: pair_start, pair_task_create, pair_task_claim, pair_task_update, pair_propose, pair_review, pair_red, pair_green, pair_refactor, pair_report, pair_verify, pair_risk, pair_arbitrate, pair_gate_check, pair_rotate, pair_status, pair_retro, pair_stop`;
}
