...
export function apply(ctx, config) {
  const resolved = {
    ...
    maxOpenRisks: config.maxOpenRisks ?? 15,
    planningMaxArbitrations: config.planningMaxArbitrations ?? 2,
    ...
    dod: parseDod(config.dod), // undefined -> the gate runs its DEFAULT_DOD list
