...
export function apply(ctx, config) {
  ...
  ctx.systemPrompt.section({
    ...
    text: usageSectionText({ tddMode: resolved.tddMode, pairStyle: resolved.pairStyle, defaultMode: resolved.defaultMode, experimentalDualDrivers: resolved.experimentalDualDrivers, dualDriverIntegrationCommand: resolved.dualDriverIntegrationCommand, ceLanes: resolved.ceLanes, ceSoloLane: resolved.ceSoloLane }),
  });
